...
def registerPlayers(tournament="Default Tournament",tplayers = 10):
    ...
    pFN =["Eden ","Sharilyn ","Merissa ","Dalia ","Ema ","Dede ","Raul ","Genaro ","Raelene ","Merrie "]
    #potential last names:
    pLN = ["Alcantar","Armstrong","Brafford","Loughran","Stager","Saia","Lyall","Tuma","Mccarville","Sollars"]
...
if __name__ == '__main__':
    ...
    for t in tournaments:
        print "\n\n TESTING TOURNAMENT '%s' WITH %s PLAYERS"%(t[0],t[1])
        setupTournament(t[0])
